...
* goal
  * describes a NEW
    * opcode (`OP_CHECKHASHVERIFY`) | Bitcoin scripting system
    * 'standard' transaction type /
      * enables
        * receiver of bitcoins can specify the transaction type / needed to re-spend them
...
* `OP_CHECKHASHVERIFY` 
  * re-define the EXISTING `OP_NOP2` opcode
  * | being executed, works
