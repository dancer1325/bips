...
* BIPs classification scheme
  * 💡-- by -- system layers💡
    * 👀lower number -> MORE intricate interoperability requirements👀

# Copyright

* Creative Commons CC0 1.0 Universal + GNU All-Permissive licenses

# Motivation

* Bitcoin
  * == system / exist MANY DIFFERENT standards

* standards types (-> require how to categorize)
  * MANDATORY to follow
    * _Example:_ for interoperability 
  * OPTIONAL to follow it
    * depend on implementers

* lower layers
  * MORE complex / get standards accepted and deployed

# Specification

* layers | categorize 
  * [standards BIPs](bip-0001.md)
    * [consensus](#1-consensus-layer)
    * [peer Services](#2-peer-services-layer)
    * [API/RPC](#3-apirpc-layer)
    * [applications](#4-applications-layer)
  * [non-standards BIPs](bip-0001.md)
    * [consensus](#1-consensus-layer)
    * [peer Services](#2-peer-services-layer)
    * [API/RPC](#3-apirpc-layer)
    * [applications](#4-applications-layer)
...
* peer services layer
  * specifies
    * how nodes
      ...
      * propagate messages
  * use cases
    * 👀ONLY a subset of specified peer services can handle basic node interoperability👀
      * == OTHERS are OPTIONAL

* entire network 
  * 👀can be upgraded (== add NEW services) WITHOUT risks of service disruption (== breaking compatibility)👀
    * -> AFTERWARD, you can gradually deprecate older services
